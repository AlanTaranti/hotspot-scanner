...
**@vitals/hotspot-scanner:** If `.specs/project/PROJECT.md` already exists, skip initialization. Offer to refresh PROJECT.md/ROADMAP.md if the user wants updated vision or milestones.
