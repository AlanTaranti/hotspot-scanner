<p align="center">
  <img src="https://img.shields.io/badge/Skill-Vitals%20Spec--Driven-blue?style=for-the-badge" alt="skill badge" />
  <img src="https://img.shields.io/badge/Project-%40vitals%2Fhotspot--scanner-green?style=for-the-badge" alt="@vitals/hotspot-scanner" />
  <img src="https://img.shields.io/badge/Version-2.1.0-purple?style=for-the-badge" alt="version" />
</p>

<h1 align="center">Vitals Spec-Driven</h1>
...
<p align="center">
  <em>Adapted from <a href="https://github.com/tech-leads-club">Tech Lead's Club</a> TLC Spec-Driven</em>
</p>

<p align="center">
  <strong>Author:</strong> Vitals (<code>@vitals/hotspot-scanner</code> adaptation)<br />
  <strong>Original author:</strong> <a href="https://github.com/felipfr">Felipe Rodrigues</a> ·
  <a href="https://linkedin.com/in/felipfr">LinkedIn</a>
</p>

## ✨ What Is This Skill?

**Vitals Spec-Driven** transforms how AI agents approach software projects in the @vitals/hotspot-scanner repository. Adapted from TLC Spec-Driven, it uses **4 adaptive phases** that auto-size based on complexity — applying full rigor for complex features and skipping ceremony for simple ones:
...
This skill ships with the repository at `.cursor/skills/vitals-spec-driven/`. No separate install step is required when working in this project.

For the upstream TLC skill: `npx @tech-leads-club/agent-skills install -s tlc-spec-driven`
...
**Goal:** Implement one task at a time. Verify. Propose commit on request. Repeat.

Every task follows the same cycle:

```
Plan → Implement → Verify → (Commit when user asks) → Next
```
...
Vitals Spec-Driven works even better when combined with complementary skills:
...
**Q: Is this skill reusable in other projects?**
A: No. **vitals-spec-driven** is project-specific to `@vitals/hotspot-scanner` (TypeScript CLI, git/complexity/scoring pipeline, Vitest). For a generic spec-driven workflow, use upstream TLC Spec-Driven.
