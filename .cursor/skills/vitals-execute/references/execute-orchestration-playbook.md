...
3. Living docs: work through [roadmap-sync.md](../../vitals-common/references/roadmap-sync.md) § Checklist (orchestrator Phase F) — sync only the docs whose content actually changed, in present tense per each `*-sot.mdc`; skip the rest. Destination per change type: [DOC-OWNERSHIP.md](../../../../.specs/codebase/DOC-OWNERSHIP.md).
